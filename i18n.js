...
(function () {
  ...
  he: {
    ...
    'partA': 'חלק א׳',
    'partB': 'חלק ב׳',
    'chipTooltipA': 'לחץ לסינון נושאי חלק א׳ בלבד — לחץ שוב לביטול. הבחירה נשמרת לפעם הבאה',
    'chipTooltipB': 'לחץ לסינון נושאי חלק ב׳ בלבד — לחץ שוב לביטול. הבחירה נשמרת לפעם הבאה',
    'nav': 'ניווט',
    ...
    'btn.procedures': 'נהלי עבודה',
    'btn.proceduresTooltip': 'נהלי עבודה קריטיים — מעקב קריאה וטופס חתימה',
    // ── מקטע נהלי עבודה (procedures.js) — שמות הנהלים עצמם נשארים בעברית ──
    'proc.title': 'נהלי עבודה קריטיים — קריאה וחתימה',
    'proc.readCount': 'נהלים שנקראו',
    'proc.pages': 'עמודים',
    'proc.col.num': 'מס׳',
    'proc.col.name': 'שם הנוהל',
    'proc.col.updated': 'עדכון',
    'proc.col.pages': 'עמ׳',
    'proc.col.date': 'נקרא בתאריך',
    'proc.sign.title': 'טופס חתימה על נהלים קריטיים',
    'proc.sign.ready': 'כל הנהלים סומנו כנקראו — אפשר למלא ולחתום.',
    'proc.sign.pending': 'למילוי לאחר קריאת כל הנהלים ברשימה.',
    'proc.sign.open': 'פתח טופס',
    'proc.folder': 'תיקיית הנהלים ב-Google Drive',
  ...
  en: {
    ...
    'partA': 'Part A',
    'partB': 'Part B',
    'chipTooltipA': 'Click to show only Part A topics — click again to clear. Your choice is remembered',
    'chipTooltipB': 'Click to show only Part B topics — click again to clear. Your choice is remembered',
    'nav': 'Navigation',
    ...
    'btn.procedures': 'Work procedures',
    'btn.proceduresTooltip': 'Critical work procedures — reading tracker and signature form',
    // ── Procedures section (procedures.js) — procedure names stay in Hebrew ──
    'proc.title': 'Critical work procedures — reading & signature',
    'proc.readCount': 'Procedures read',
    'proc.pages': 'pages',
    'proc.col.num': 'No.',
    'proc.col.name': 'Procedure',
    'proc.col.updated': 'Updated',
    'proc.col.pages': 'Pages',
    'proc.col.date': 'Read on',
    'proc.sign.title': 'Critical procedures signature form',
    'proc.sign.ready': 'All procedures marked as read — ready to fill in and sign.',
    'proc.sign.pending': 'Fill in after reading every procedure on the list.',
    'proc.sign.open': 'Open form',
    'proc.folder': 'Procedures folder on Google Drive',
  ...
  ru: {
    ...
    'partA': 'Часть А',
    'partB': 'Часть Б',
    'chipTooltipA': 'Нажмите, чтобы показать только темы части А — повторное нажатие снимает фильтр. Выбор сохраняется',
    'chipTooltipB': 'Нажмите, чтобы показать только темы части Б — повторное нажатие снимает фильтр. Выбор сохраняется',
    'nav': 'Навигация',
    'allTopics': 'Все темы',
    ...
    'btn.procedures': 'Рабочие протоколы',
    'btn.proceduresTooltip': 'Критические рабочие протоколы — учёт прочтения и форма подписи',
    // ── Раздел протоколов (procedures.js) — названия протоколов остаются на иврите ──
    'proc.title': 'Критические рабочие протоколы — чтение и подпись',
    'proc.readCount': 'Прочитано протоколов',
    'proc.pages': 'страниц',
    'proc.col.num': '№',
    'proc.col.name': 'Название протокола',
    'proc.col.updated': 'Обновлён',
    'proc.col.pages': 'Стр.',
    'proc.col.date': 'Дата прочтения',
    'proc.sign.title': 'Форма подписи о прочтении критических протоколов',
    'proc.sign.ready': 'Все протоколы отмечены как прочитанные — можно заполнить и подписать.',
    'proc.sign.pending': 'Заполняется после прочтения всех протоколов из списка.',
    'proc.sign.open': 'Открыть форму',
    'proc.folder': 'Папка протоколов на Google Drive',
